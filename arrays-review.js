...
let foods = ['apple', 'orange', 'pear', 'plum'];
...
let cities = ['New York', 'Boston', 'Seattle', 'LA', 'San Diego'];
...
let emptyArray = [];
let num = readline.question('how many number of letters would you like to enter? ');
...
for (let i = 0; i < 10; i++) {
  emptyArr1.push(Math.floor(Math.random() * 10));
}
